...
class Nav extends Controller
{
  ...
  public function ss(){
	...
	public function index()
	{
		...
		if ($_var_7 == 0) {
			$_var_5['recommend_roll_ad_list'] = db('banner')->where('cid' , 3)->select();
		} else {
			$_var_5['recommend_roll_ad_list']= db('banner')->where('cid' , 3)->select();
		}
		...
		if ($_var_8 == 0) {
			$_var_5['recommend_banner_ad'] = db('banner')->where('cid' , 4)->select();
		} else {
			$_var_5['recommend_banner_ad'] = db('banner')->where('cid' , 4)->select();
		}
		...
		if ($_var_9 == 0) {
			$_var_5['recommend_big_picture_ad_list'] = db('banner')->where('cid' , 5)->select();
		} else {
			$_var_5['recommend_big_picture_ad_list'] = db('banner')->where('cid' , 5)->select();
		}
		...
		if ($_var_10 == 0) {
			$_var_5['recommend_small_picture_ad_list'] = db('banner')->where('cid' , 6)->select();
		} else {
			$_var_5['recommend_small_picture_ad_list'] = db('banner')->where('cid' , 6)->select();
		}
		...
		if ($_var_11 == 0) {
			$_var_5['recommend_top_ad'] = db('banner')->where('cid' , 7)->select();
		} else {
			$_var_5['recommend_top_ad'] = db('banner')->where('cid' , 7)->select();
		}
		...
		if ($_var_13 == 0) {
			$_var_5['recommend_text_ad_list'] = db('banner')->where('cid',25)->select();
		} else {
			$_var_5['recommend_text_ad_list'] = db('banner')->where('cid',25)->select();
		}
