<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"/www/wwwroot/cs.xiao18.top/application/index/view/dianka/slog.html";i:1543998454;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="panel-body">
                <div style="text-align: center">
                    <form class="validate" method="get" action="<?php echo url('dianka/slog'); ?>">
                        ...
                        <input class="form-control layui-input" placeholder="&nbsp;点卡" type="text" name="user" style="height: 38px">

                        <button type="submit" class="layui-btn layui-btn-blue" style="height: 38px;margin-top: 7px;">搜索</button>
                    </form>
                ...
                <div class="" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk"
                    ...
                    <div class="layui-form table-responsive" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk"
