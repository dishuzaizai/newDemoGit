<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"/www/wwwroot/cs.xiao18.top/application/index/view/user/mlog.html";i:1544016250;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="panel-body">
                <div style="text-align: center">
                    <form method="get" action="<?php echo url('user/mlog'); ?>">
                       操作日期 <input type="date" name="start" class="layui-input" >&nbsp;-&nbsp;<input type="date" name="end" class="layui-input" >
                        <?php if(session('power')=='0'){?>
                        <span class="layui-clear" style="margin-bottom: 10px;display: block"></span>
                        <input placeholder="&nbsp;代理账户关键词" type="text" name="user"class="layui-input">
                        <?php }?>
                        <span class="layui-clear" style="margin-bottom: 10px;display: block"></span>
                        <input placeholder="&nbsp;用户账户关键词" type="text" name="vip" class="layui-input">
