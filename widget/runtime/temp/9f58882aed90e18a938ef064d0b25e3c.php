<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"/www/wwwroot/cs.xiao18.top/application/index/view/index/index.html";i:1584029126;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="layui-row layui-col-space15">
                    ...
                    <div class="layui-card-body layui-text">
                      <div class="layuimini-notice">
                            <div class="layuimini-notice-title">南风更新修复现有功能</div>
                            <div class="layuimini-notice-extra">2020-02-13 23:06</div>
                            <div class="layuimini-notice-content layui-hide">
                                全新源码<br>
                                同步全网更新最新源码对接苹果CMS系统，使您观影更加流畅<br>
                            </div>
                          <div class="layuimini-notice-content1" style="display: none!important;">
                           http://wpa.qq.com/msgrd?v=3&uin=13457530&site=qq&menu=yes
                            </div>
                        </div>
                    ...
                    <div class="layui-card-body layui-text">
                        <table class="layui-table">
                            ...
                            <tr>
                                ...
                                <td>
                                  13457530
                                  <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=13457530&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:1339431070:51" alt="点击这里给我发消息" title="点击这里给我发消息"/></a>
                              </td>
                            </tr>
                            <tr>
                                <td>问题反馈</td>
                                <td style="padding-bottom: 0;">
                                    <div class="layui-btn-container">
                                        <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=13457530&site=qq&menu=yes"><img border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="千月对接苹果cms影视交" title="千月对接苹果cms影视交"></a>
