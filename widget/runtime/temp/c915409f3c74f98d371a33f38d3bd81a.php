<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"/www/wwwroot/cs.xiao18.top/application/index/view/yhtx/txjl.html";i:1585135406;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="row">
  ...
  <div class="table-responsive" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk"
      ...
      <td><?php echo $vo['zfb']; ?></td>   
           <?php }?>
          <td><font  color="red"><?php echo $vo['jine']; ?></font></td>
          <td><?php echo date("Y-m-d H:i:s",$vo['time']); ?></td>
          <td><?php echo $vo['status']; ?>已支付</td>
         <td>
