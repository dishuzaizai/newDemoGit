<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"/www/wwwroot/cs.xiao18.top/application/app/view/index/m.html";i:1585150988;}*/ ?>
﻿
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    ...
    <title>爱看视频_APP下载在线免费观看全网影视</title>
...
<div class="warp">
    <div class="header">
        <div class="soft-logo">
            <img src="../../../../images/logo.png" alt="完美视界">	
        </div>
        <div class="soft-name">
            <p>完美视界</p>
            <p><b>50万人已下载此应用</b></p>
