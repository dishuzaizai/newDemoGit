<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"/www/wwwroot/cs.xiao18.top/application/index/view/video/index.html";i:1549187836;}*/ ?>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk"
                    ...
                    <div class="btn-toolbar">
                        <div class="btn-group focus-btn-group">
                            <a href="https://piaofang.maoyan.com/dashboard">
                                <button class="layui-btn layui-btn-blue"><i class="el-pencil"></i> 电影票房</button>
                            </a>
                        </div>                        
