<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"/www/wwwroot/cs.xiao18.top/application/index/view/user/xlog.html";i:1544016078;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="panel-body">
                <div style="text-align: center">
                    <form class="validate" method="get" action="<?php echo url('user/xlog'); ?>">
                       操作日期 <br><input class="form-control layui-input"  type="date" name="start" >-<input type="date" name="end" class="form-control" >
                        <?php if(session('power')=='0'){?>
                        <span class="layui-clear" style="margin-bottom: 10px;display: block"></span>
                        <input placeholder="&nbsp;代理账户关键词" type="text" name="user" class="form-control layui-input" >
                        <?php }?>
                        <span class="layui-clear" style="margin-bottom: 10px;display: block"></span>
                        <input placeholder="&nbsp;用户账户关键词" type="text" name="vip" class="form-control layui-input" >
                        <span class="layui-clear" style="margin-bottom: 10px;display: block"></span>
                        <select name="day" class="form-control layui-input">
                            <option value=""}>所有</option>
                            <option value="0.5"}>七天</option>
                             <option value="1.5"}>一个月</option>
                             <option value="2.5"}>三个月</option>
