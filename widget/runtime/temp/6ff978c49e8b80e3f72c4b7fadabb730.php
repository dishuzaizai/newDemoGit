<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"/www/wwwroot/cs.xiao18.top/application/index/view/banner/index.html";i:1584502426;}*/ ?>
                    ...
                    <div class="btn-toolbar">
                       	<div class="btn-group focus-btn-group">
                            ...
                            <a href="/index/banner/index/id/2.html">
                                <button class="btn btn-info"> 影视VIP</button>
                            </a>
                        </div>
                                                  <div class="btn-group focus-btn-group">
                            <a href="/index/banner/index/id/3.html">
                                <button class="btn btn-info"> 推荐中部滚动</button>
                            </a>
                        </div>
                                                  <div class="btn-group focus-btn-group">
                            <a href="/index/banner/index/id/4.html">
                                <button class="btn btn-info"> 推荐BANNER</button>
                            </a>
                        </div>
                                                  <div class="btn-group focus-btn-group">
                            <a href="/index/banner/index/id/5.html">
                                <button class="btn btn-info"> 推荐横幅大图</button>
                            </a>
                        </div>
                                                  <div class="btn-group focus-btn-group">
                            <a href="/index/banner/index/id/6.html">
                                <button class="btn btn-info"> 推荐页横幅小图</button>
                            </a>
                        </div>
						<div class="btn-group focus-btn-group">
                            <a href="/index/banner/index/id/25.html">
                                <button class="btn btn-info"> 推荐页文字广告</button>
                            </a>
                        </div>
                                                  <div class="btn-group focus-btn-group">
                            <a href="/index/banner/index/id/7.html">
                                <button class="btn btn-info"> 推荐HOT</button>
                            </a>
                        </div>
                                                  <div class="btn-group focus-btn-group">
                            ...
                            <a href="/index/banner/index/id/12.html">
                                <button class="btn btn-info"> 首页右上角广告</button>
                            </a>
                        </div>
                                                  <div class="btn-group focus-btn-group">
                            ...
                            <a href="/index/banner/index/id/21.html">
                                <button class="btn btn-info"> 发现页中部轮播</button>
                            </a>
                        </div>
                                                  <div class="btn-group focus-btn-group">
                            ...
                            <a href="/index/banner/index/id/23.html">
                                <button class="btn btn-info"> 发现为您推荐</button>
                            </a>
                        </div>
