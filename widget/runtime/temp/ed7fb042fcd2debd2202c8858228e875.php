<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"/www/wwwroot/cs.xiao18.top/application/index/view/dao/copy.html";i:1544010044;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
function copyUrl2()
    {
        ...
        layer.msg('激活码复制成功');
                ...
                <p class="flex-two"><span class="fq-shareapp-code"  id="Copy"   onClick="copyUrl2()">- - -</span>
                </p>
