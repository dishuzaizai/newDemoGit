<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"/www/wwwroot/cs.xiao18.top/application/index/view/mn/update.html";i:1584450692;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
  ...
  <!--标题-->
       ...
       <div class="panel-heading">
               ...
               <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 首页推荐视频修改
         </div>
        ...
        <form role="form" id="form1"  method="post" action="<?php echo url('mn/edit'); ?>" enctype="multipart/form-data" class="validate">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <input type="text" class="form-control" name="region" value="<?php echo $data['region']; ?>"  placeholder="" />
            </div>
            <div class="form-group">
                <label class="control-label">类型</label>

                <input type="text" class="form-control" name="type" value="<?php echo $data['type']; ?>"  placeholder="" />
            </div>			
          <div class="form-group">
