<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"/www/wwwroot/cs.xiao18.top/application/index/view/user/add.html";i:1550005090;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="panel-body">
        ...
        <form role="form" id="form1" method="post" action="<?php echo url('user/add'); ?>" class="validate">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control layui-input" name="name" data-validate="required,minlength[4],maxlength[18]" data-message-required="账号必填,长度最小为4个字符,最大为18个字符" placeholder="账号" />
            </div>

            <div class="form-group">
                <label class="control-label">密码</label>

                <input type="password" class="form-control layui-input" id="password" name="password" data-validate="required,minlength[4],maxlength[18]"  data-message-required="密码必填,长度最小为4个字符,最大为18个字符" placeholder="密码" />
            </div>

            <div class="form-group">
                <label class="control-label">确认密码</label>

                <input type="password" class="form-control layui-input" name="_password" data-validate="required,minlength[4],equalTo[#password],maxlength[18]" data-message-required="确认密码必填,长度最小为4个字符,最大为18个字符,并与密码一致" placeholder="确认密码" />
            </div>

            <div class="form-group" id="wei" >
                <label class="control-label">微信</label>

                <input type="text" class="form-control layui-input" name="weichat" data-validate="required" value="" data-message-required="微信必填" placeholder="微信" />
            </div>

            <div class="form-group">
                <label class="control-label">联系方式</label>

                <input type="text" class="form-control layui-input" name="phone" data-validate="required" data-message-required="联系方式必填" placeholder="QQ或者微信" />
            </div>
            ...
            <div class="form-group">
                ...
                <select name="power" id="ss"  class="form-control layui-input">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control layui-input" name="share_ma"  placeholder="推荐码不能为汉字" />
            </div><?php }?>
