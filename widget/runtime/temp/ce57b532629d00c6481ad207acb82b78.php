<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"/www/wwwroot/cs.xiao18.top/application/index/view/tv/update.html";i:1544000162;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="panel-body">
        ...
        <form role="form" id="form1"  method="post" action="<?php echo url('tv/edit'); ?>" enctype="multipart/form-data" class="validate">
            ...
            <div class="form-group">
                ...
                <input type="file" class="form-control layui-input" name="img" />
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control layui-input" name="img"  value="<?php echo $data['img']; ?>"  placeholder="" />
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control layui-input" name="title" value="<?php echo $data['title']; ?>"  placeholder="" />
            </div>

            <div class="form-group">
                <label class="control-label">播放地址</label>

                <input type="text" class="form-control layui-input" name="url" value="<?php echo $data['url']; ?>"  placeholder="" />
            </div>
