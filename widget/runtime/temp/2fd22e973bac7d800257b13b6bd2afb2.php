<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"/www/wwwroot/cs.xiao18.top/application/index/view/shangcheng/index.html";i:1584450100;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
               ...
               <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 消息通知管理
                    </div>
    <!--标题-->
  ...
  <div class="table-responsive" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk"
                    ...
                    <table cellspacing="0" class="table table-small-font table-bordered table-striped">
                        <thead>
                        <tr>
						    <th style="width: 120px">通知id</th>
                          	<th style="width: 180px">通知图片</th>
                            <th>标题</th>
                            <th>内容</th>  
                            <th>链接</th>
							<th>时间</th>
